...
import com.github.book.common.StringUtil;
import com.github.book.meta.BookContentPaths;
...
public class BookContentResolver {
    ...
    public BookContentResolver(String rootPath) {
    ...
    private ManifestItem getFirstManifestItem(List<ManifestItem> items,String mediaTypeRegex){
        for(ManifestItem item : items){
            ...
            if(mediaType.matches(mediaTypeRegex))
                return item;
        }
